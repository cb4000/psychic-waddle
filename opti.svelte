<script>
  ...
  function handleViewResults(runId) {
    console.log(`Viewing results for run ${runId}`);
  }
    ...
    <div class="tab-content">
      <div class="variables-container">
        <div class="variable-section optimization-variables">
          ...
          {#each optimizationData.optimizationVariables as variable}
        ...
        <div class="variable-section other-variables">
          ...
          {#each optimizationData.otherVariables as variable}
            <div class="variable-item">
              <span class="variable-name">{variable.name}</span>
              <span class="variable-value">{variable.currentValue}{variable.unit}</span>
            </div>
      ...
      <div class="controls-section">
        ...
        <button class="optimize-button" on:click={handleOptimize}>
          Run Optimization
        </button>
      </div>
    </div>
          ...
          <div class="run-item">
            ...
            <div class="run-actions">
              {#if run.status === 'completed'}
                <button class="action-button action-view" on:click={() => handleViewResults(run.id)}>
                  View Results
                </button>
                <button class="action-button action-download" on:click={() => handleDownload(run.id)}>
                  Download
                </button>
              {/if}
              ...
              {/if}
              <button class="action-button action-delete" on:click={() => handleDelete(run.id)}>
                Delete
              </button>
            </div>
          </div>
